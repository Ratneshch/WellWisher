...
const Footer = () => {
  return (
    <footer className="px-4 sm:px-6 md:px-10 lg:px-15 xl:px-20 pt-10 w-full  text-gray-500 bg-gray-200/10">
      {/* Top Section */}
        ...
        <div className="flex flex-row flex-1 items-start justify-center gap-6 sm:gap-12 md:gap-20 mt-6 md:mt-0 text-center md:text-left">
          ...
          <div>
            ...
            <ul className="text-sm space-y-2">
              ...
              <li><Link href="/newcars" className="hover:text-gray-800 transition-colors">Cars</Link></li>
              <li><Link href="/aboutus" className="hover:text-gray-800 transition-colors">About Us</Link></li>
              <li><Link href="/contactus" className="hover:text-gray-800 transition-colors">Contact Us</Link></li>
            </ul>
          </div>
